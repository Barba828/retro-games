...
CPU.prototype = {
  ...
  reset: function () {
    ...
    console.log('lnz this.mem init ', this.mem[65534]);
    ...
    if(this.mem[65534]!==undefined)console.log('lnz MEMEMEMEME 0', this.mem[65534]);
  ...
  emulate: function () {
    ...
    var dataIndex = this.nes.mmap.load(this.REG_PC + 1)
    var opinf = this.opdata[dataIndex];

    // console.log('lnz REG_PC before', this.REG_PC, opinf, opinf & 0xff);
    // if(opinf === 255){
    //   console.log('lnz before 255 => ', this.REG_PC, opinf, addr);
    // }
    ...
    switch (opinf & 0xff) {
      ...
      case 10: {
        ...
        this.REG_PC--;
        console.log('lnz BRK', this.load16bit(0xfffe));
        break;
      }
      case 11: {
        // *******
      ...
      default: {
        ...
        console.log('lnz cpu error ', opinf);
        this.nes.stop();
    ...
    if(opinf===8193){
      console.log('lnz after 8193 => ', this.REG_PC, opinf, addr);
    }
    if(opinf === 255){
      console.log('lnz after 255 => ', this.REG_PC, opinf, addr);
    }
    // console.log('lnz REG_PC after', this.REG_PC, opinf, addr);
  ...
  load16bit: function (addr) {
    if (addr < 0x1fff) {
      ...
      // console.log('lnz load16bit',addr, this.nes.mmap.load(addr));
      console.log('lnz load16bit addr', addr);
      console.log('lnz load16bit memo', this.mem[65534]);
